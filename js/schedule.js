...
addEventSubmit.addEventListener("click", () => {
  ...
  if (schedulerName === "" ||eventTitle === "" || eventTimeFrom === "" || eventTimeTo === "") {
...
addEventSubmit.addEventListener("click", () => {
  ...
  // Store scheduler name and event date in local storage
  localStorage.setItem("schedulerName", schedulerName);
  localStorage.setItem("eventDate", eventDate);

  // Redirect to notification.html
